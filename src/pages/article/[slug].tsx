...
export default function ArticlePage({
	...
	const publishDate = useMemo(() => {
		return currentArticle?._sys?.createdAt ? formatDate(currentArticle._sys.createdAt) : ''
		...
		<Layout app={app}>
			...
			<main className={styles.Container}>
				<article v-if="currentArticle" className={styles.Article}>
					...
					<div className={styles.Article_Body} dangerouslySetInnerHTML={body}></div>
					...
					<aside className={styles.Author}>
						...
						<div className={styles.Author_Text}>
							...
							<div className={styles.Author_Description} dangerouslySetInnerHTML={authorBio}></div>
						</div>
					</aside>
					<nav className={styles.Links}>
						{prevArticle && (
							<Link href={`/article/${prevArticle.slug}`} className={styles.Links_Previous}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									height="24px"
									viewBox="0 0 24 24"
						...
						{nextArticle && (
							<Link href={`/article/${nextArticle.slug}`} className={styles.Links_Next}>
								Next post
								<svg
									xmlns="http://www.w3.org/2000/svg"
